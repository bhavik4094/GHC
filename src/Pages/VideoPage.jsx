...
const videoCardData = [
    {
        ...
        url: 'https://landing-page-app-hero-images.s3.amazonaws.com/media/f9fe6f94-78af-4d5e-ad86-395551491a50.mp4',
    ...
    },
    {
        ...
        url: 'https://landing-page-app-hero-images.s3.amazonaws.com/media/4b6671b4-95e9-4390-9b2e-1b29a2d62eca.mp4',
                ...
                <div className="container videoCards-Container">
                    <ul className="video-list list-unstyled">
                        {videoCardData.map((video, index) => {
                            ...
                            const currentInfo = videoInfo[index] || {};
                            return (
                                <VideoCard
                                    key={index}
                                    video_title={currentInfo.heading || "Heading Not Found"}
                                    video_para={currentInfo.description || "Description Not Found"}
                                    video_url={video.url}
                                    isLast={isLast}
                                />
                            );
