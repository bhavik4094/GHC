    ...
    <div className="review-card bg-white text-dark">
        ...
        <div className="d-flex flex-column justify-content-between" style={{ height: "331px" }}>
            ...
            <div>
                ...
                <span className="badge review-category text-uppercase">{review.category}</span>
            </div>
        </div>
    </div>
);
            ...
            <div className="container-xxl testimonial-container">
                <div className="title-wrapper">
                    <p className="text-light heading-upper-text review-subheading-text mb-0">
                        <span className='bg-black' style={{ padding: "5px 0px" }}>  TAKE A LOOK FOR YOURSELF ON WHAT YOUR NEIGHBORS ARE SAYING ABOUT US.</span>
                ...
                <div className="position-relative d-flex justify-content-center px-5" style={{ minHeight: "502px" }}>
