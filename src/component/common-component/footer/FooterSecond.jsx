                    ...
                    <div className="col-lg-4 col-md-12">
                        <div className="bg-white text-black py-4 px-3 m-0">
                            <div className="row">
                                ...
                                <div className='col-7 footer-contact-card-content' style={{ wordBreak: 'break-word', overflowWrap: 'break-word' }}>
                            ...
                            <div className="d-flex">
                                ...
                                <img src={googleLogo} alt="google-logo" className='footer-card-logo' />
                                <img src={facebookLogo} alt="facebook-logo" className='footer-card-logo' />
                                <img src={nextdoorLogo} alt="nextdoor-logo" className='footer-card-logo' />
                            </div>
                        </div>
                    </div>
